...
// Retrieve recipe data including average rating from the database
$sql = "SELECT recipe.recipe_id, recipe.recipe, recipe.recipe_image, users.username, AVG(rating.rating) AS avg_rating
        FROM recipe
